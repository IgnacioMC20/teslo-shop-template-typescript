...
export const initialData: SeedData = {
    ...
    departments: [
        { title: 'Alta Verapaz', code: 'AV' },
        { title: 'Baja Verapaz', code: 'BV' },
        { title: 'Chimaltenango', code: 'CH' },
        { title: 'Chiquimula', code: 'CQ' },
        { title: 'El Progreso', code: 'EP' },
        { title: 'Escuintla', code: 'ES' },
        { title: 'Guatemala', code: 'GT' },
        { title: 'Huehuetenango', code: 'HH' },
        { title: 'Izabal', code: 'IZ' },
        { title: 'Jalapa', code: 'JP' },
        { title: 'Jutiapa', code: 'JT' },
        { title: 'Petén', code: 'PT' },
        { title: 'Quetzaltenango', code: 'QZ' },
        { title: 'Quiché', code: 'QC' },
        { title: 'Retalhuleu', code: 'RL' },
        { title: 'Sacatepéquez', code: 'SP' },
        { title: 'San Marcos', code: 'SM' },
        { title: 'Santa Rosa', code: 'SR' },
        { title: 'Sololá', code: 'SL' },
        { title: 'Suchitepéquez', code: 'SU' },
        { title: 'Totonicapán', code: 'TT' },
        { title: 'Zacapa', code: 'ZC' },
    ],
    products: [
        {
